...
if __name__ == "__main__":
    dir_path = os.path.expanduser("~/") + "1_OODEEL/experiments_v4/benchmark/results/torch"
    os.makedirs(dir_path, exist_ok=True)

    # run benchmark
    benchmark = BenchmarkTorch(device, experiments=["cifar10", "imagenet"])

...
def get_train_dataset_ImageNet_1K():
    # Initialize the ImageNet_1K datasets for training and testing
    train_dataset = ImageNet_1K( train=True, transform=transform)
...
def get_test_dataset_ImageNet_1K():
    # Initialize the ImageNet_1K datasets for training and testing
    test_dataset = ImageNet_1K( train=False, transform=transform)
    print("the length of the ImageNet_1K Test dataset : ", len(test_dataset))
    # Create the DataLoaders for training and testing

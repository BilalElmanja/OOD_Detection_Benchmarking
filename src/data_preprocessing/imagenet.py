...
class ImageNet_V2(Dataset):
    def __init__(self, train=False, transform=None):
        ...
        """
        self.root_dir = "../../data/ImageNet-V2"
        self.train = train
...
def get_train_dataset_ImageNet_V2():
    # Initialize the ImageNet_V2 datasets for training and testing
    train_dataset = ImageNet_V2( train=True, transform=transform)
    print("the length of the ImageNet_V2 Training dataset : ", len(train_dataset))
    # Create the DataLoaders for training and testing
    train_loader = DataLoader(train_dataset, batch_size=128, shuffle=True, num_workers=4)
    return train_loader

def get_test_dataset_ImageNet_V2():
    # Initialize the ImageNet_V2 datasets for training and testing
    test_dataset = ImageNet_V2( train=False, transform=transform)
    print("the length of the ImageNet_V2 Test dataset : ", len(test_dataset))
    # Create the DataLoaders for training and testing
